---
title: "Two-Step Kernel Method Exploration (20 props, 3 & 10 small ps)"
author: "Kelvin Njuki"
date: "`r Sys.Date()`"
output:
...
for (i in 1:3){
  ...
  plot(density(xx), col = "red", xlab = "Similarity", xlim = c(0.1,0.7), ylim = c(0, 7),  
...
for (i in 1:4){
  ...
  plot(density(xx), col = "red", xlab = "Similarity", #xlim=c(0,2.5), ylim=c(0,10), 
...
legend("top", inset = 0,
       legend = c("Step 1: Hamming", paste("Step 2:", distvec),
                  "Closure: No", "Combine: Sum"),
       bty = "n", cex = 1.1, text.font = 1)
...
for (i in 1:4){
  ...
  plot(density(xx), col = "red", xlab = "Similarity", #ylim=c(0,8), xlim=c(0,2.5),
       main = distvec2[i], font.main = 1, cex.main = 1)
...
for (i in 1:4){
  ...
  plot(density(xx), col = "red", xlab = "Similarity", #ylim=c(0,8), xlim=c(0,0.5),
       main = distvec2[i], font.main = 1, cex.main = 1)
...
for (i in 1:4){
  ...
  plot(density(xx), col = "red", xlab = "Similarity", #ylim=c(0,10), xlim=c(0,2.5),
       main = distvec2[i], font.main = 1, cex.main = 1)

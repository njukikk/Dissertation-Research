...
# Power Analysis for the Two-Step Kernel Method (20 props, 3 & 10 small ps Compositional Data)
...
case1_20props_3small_2step_vs_0imputation <- cbind.data.frame(alphavec, powervec.two.step.case1, 
                                                              powervec.zero.imputed.case1)

write.csv(case1_20props_3small_2step_vs_0imputation, 
          paste0(getwd(), "/case1_20props_3small_2step_vs_0imputation.csv"), row.names = TRUE)
...
for (i in 1:reps){
  ...
  props.pseudo.new <- add.new.effects(maxeffect = 0.0004, prop = props.pseudo, n.nochange = 0, ind.nochange = NULL)
...
case2_20props_3small_2step_vs_0imputation <- cbind.data.frame(ds.pseudo.case2, powervec.two.step.case2, 
                                                              powervec.zero.imputed.case2)

write.csv(case2_20props_3small_2step_vs_0imputation, 
          paste0(getwd(), "/case2_20props_3small_2step_vs_0imputation.csv"), row.names = TRUE)
...
for (i in 1:reps){
  ...
  betarev1 <- getES.mlogit(props.pseudo)
  props.pseudo.new <- add.new.effects(maxeffect = 0.004, prop = props.pseudo, n.nochange = 10, ind.nochange = 3:12)
...
# saving case 2 data for future use
case3_20props_3small_2step_vs_0imputation <- cbind.data.frame(ds.pseudo.case3, powervec.two.step.case3, 
                                                              powervec.zero.imputed.case3)

write.csv(case3_20props_3small_2step_vs_0imputation, 
          paste0(getwd(), "/case3_20props_3small_2step_vs_0imputation.csv"), row.names = TRUE)
...
for (i in 1:reps){
  ...
  betarev1 <- getES.mlogit(props.pseudo)
  props.pseudo.new <- add.new.effects(maxeffect = 0.009, prop = props.pseudo, n.nochange = 15, ind.nochange = 2:16)
...
# saving case 2 data for future use
case4_20props_3small_2step_vs_0imputation <- cbind.data.frame(ds.pseudo.case4, powervec.two.step.case4, 
                                                              powervec.zero.imputed.case4)

write.csv(case4_20props_3small_2step_vs_0imputation, 
          paste0(getwd(), "/case4_20props_3small_2step_vs_0imputation.csv"), row.names = TRUE)
...
all3cases_20props_3small_2step_vs_0imputation <- cbind.data.frame(ds.pseudo, powervec.two.step.3cases, 
                                                                  powervec.zero.imputed.3cases)
write.csv(all3cases_20props_3small_2step_vs_0imputation, 
          paste0(getwd(), "/all3cases_20props_3small_2step_vs_0imputation.csv"), row.names = TRUE)

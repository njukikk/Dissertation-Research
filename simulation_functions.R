...
simulation_study_pseudo <- function(beta, betaX, Xmat, nvec, sigb, num.sim, num.perm = 10000, printafter = 100, 
  ...
  for (i in 1:num.sim){
    ...
    if (method == "Two.Step"){
      ...
      out <- dcor.comp.2step(propmat, xvec, num.perm = num.perm, Xdist = Xdist, 
                             ...
                             combinethru = combinethru, result = c("test"))
      ...
      out <- dcor.comp(propmat, xvec, num.perm, Xdist = Xdist, result = c("test")) 
